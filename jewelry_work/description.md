# Задача: Ювелирная работа

Ссылка на задачу: [https://coderun.yandex.ru/problem/jewelry-work]
...
Такую процедуру он проделывал
K
K раз, и каждый раз оказывалось, что жемчужина была подходящей. Какое минимальное
K
K может гарантировать, что жемчуга ювелиру хватит для выполнения своей работы с вероятностью не меньше 95%, если считать, что доля качественных жемчужин априори распределена равномерно?
