# Задача: Выберите три числа, содержащие все цифры от 0 до 9

Ссылка на задачу: [https://coderun.yandex.ru/problem/three-numbers]
...
В первой строке записано число $t$ — количество тестовых наборов $(1 \le t \le 100)$.

Далее следуют описания тестовых наборов. Каждый тестовый набор занимает 2 строки:

- В первой строке записано число $n$ $(3 \le n \le 30)$ — количество чисел в наборе.
- Во второй строке записаны $n$ чисел $a_i$. Все $a_i$ различны.
